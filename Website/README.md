...
Do not move the Android source into this folder. Website development and deployment should be independent of the native Android build. No hosting provider, production URL, frontend framework, or deployment workflow has been selected by this folder organization.
