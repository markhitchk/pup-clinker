...
internal object PuppyCasinoRewardEngine {
    ...
    /**
     * Rare bonus Upgrade Ticket chance for profitable completed rounds:
     * profit <2x = 0.25%, 2x–<5x = 0.5%, 5x–<20x = 1%,
     * 20x–<100x = 2%, and 100x+ = 5%.
     */
    fun dropChanceBasisPoints(round: PuppyCasinoRound): Int {
        ...
        return when {
            ratioAtLeast(payout, wager, 100L) -> 500
            ratioAtLeast(payout, wager, 20L) -> 200
            ratioAtLeast(payout, wager, 5L) -> 100
...
internal object PuppyCasinoRewardPersistence {
    ...
    internal const val LEDGER_KEY = "casino_ticket_reward_ledger_v1"
