...
internal fun PuppyOnboardingShell(
    ...
    val headerVerticalPadding = if (preferViewportFit) 2.dp else 4.dp
    val bodyVerticalPadding = if (preferViewportFit) 0.dp else 2.dp
    val footerSpacing = if (preferViewportFit) 8.dp else 16.dp
    val bodyBottomSpacing = if (preferViewportFit) 8.dp else 18.dp
    val navigationVerticalPadding = if (preferViewportFit) 2.dp else 4.dp
    Surface(
